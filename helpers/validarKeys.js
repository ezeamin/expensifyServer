const validarKeys = (type, obj) => {
    const keys = {
        ...
        newUserDebt: ["lenderName", "title","price", "description", "destinationAccountId","date","tzOffset"],
        newOtherDebt: ["debtorName", "title", "price", "description", "originAccountId","date","tzOffset"],
